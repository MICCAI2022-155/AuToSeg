...
def marching_cubes(res, name='vessel', level=0.9, spacing=1, method=None, smooth=False, show=True):
    if smooth:
    ...
    if method == 'skimage':
        ...
        verts, faces = mcubes.marching_cubes(data, 0.9)
...
if __name__ == '__main__':
    ...
    root_path = '/Users/px/Downloads/watershed'
    save_root = '/Users/px/Downloads/watershed_surface_mesh'
